...
#mount -t cifs -o username=Dell,password=Pass1234 //10.40.54.65/share /mnt/share
#umount /mnt/share
#
#--------------------------------------------------------------------------------------------
...
script -c "
	sshpass -p ${p} ssh ${u}@${d} <<-'ENDSSH'
        ...
        #racadm closessn -a
	#racadm swinventory
    racadm get -t xml -f ${d}.xml -l 10.40.54.199:/export/nfs -u root -p Pass1234 -c BIOS.Setup.1-1
